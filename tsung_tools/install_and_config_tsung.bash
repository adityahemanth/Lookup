...
mkdir lookup_gcp_1000000users_1min_output
cd lookup_gcp_1000000users_1min_output
/usr/lib/tsung/bin/tsung_stats.pl --stats /home/omid55/.tsung/log/20160528-2110/tsung.log
